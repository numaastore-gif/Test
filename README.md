...
| Plano de pistas | SVG interactivo de las 7 pistas + cafetería, con estado libre/ocupada, teclado accesible y salto directo a la reserva de esa pista. |
...
| Generador de Americano | Rotación de parejas y rivales por rondas, reparto por pistas, descansos (BYE) automáticos y cuadro copiable al portapapeles. |
